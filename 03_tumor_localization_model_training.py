"""
03_tumor_localization_model_training.py — Brain Tumor Detection Localizer Training
=========================================================================
...
Skip Logic
----------
If runs/detect/tumor_localizer/weights/best.pt exists and is > 1 MB,
...
CHECKPOINT_DIR   = "runs/detect/tumor_localizer"
...
def train_tumor_localizer() -> None:
    ...
    print("=" * 70)
    print("  Brain Tumor Detection — Tumour Localizer Training (YOLOv11n)")
    print("=" * 70)
