"""
01_neuroimaging_data_acquisition.py — Brain Tumor Detection Data Acquisition
=====================================================================
...
def prepare_neuroimaging_datasets() -> None:
    ...
    """
    print("=" * 70)
    print("  Brain Tumor Detection — Base Neuroimaging Data Acquisition (2-D Slice Datasets)")
    print("=" * 70)
